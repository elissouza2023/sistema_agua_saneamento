...
section[data-testid="stSidebar"] {
    background-color: rgba(57,91,94,0.92);
}
...
/* RODAPÉ */
.rodape {
    background-color: rgba(57,91,94,0.95);
    color: white;
    text-align: center;
    padding: 15px;
    border-radius: 15px;
...
def carregar_dados():
    ...
    df['RECEITA_POTENCIAL'] = (
        df['CONSUMO_ACUMULADO'] * tarifa_media
    )
...
if pagina == "🏠 Visão Geral":
    ...
    Visão Geral de KPIs estratégicos visando identificação
    de oportunidades de recuperação de receitas e detecção
    de fraudes e inconsistências.
    </div>
    """, unsafe_allow_html=True)
...
# =========================================================
    ...
    st.markdown("""
    <div class="insight-container">
    Os dados indicam crescimento progressivo da perda estimada
    em hidrômetros próximos ou acima da vida útil recomendada.
    </div>
    """, unsafe_allow_html=True)
...
# =========================================================
    ...
    st.markdown("""
    <div class="insight-container">
    Ligações com comportamento atípico e potencial necessidade
...
# =========================================================
    ...
    st.markdown("""
    <div class="insight-container">
    Foi identificado percentual relevante de hidrômetros
    acima da vida útil recomendada pela Portaria 155/2022.
    </div>
    """, unsafe_allow_html=True)
...
# =========================================================
    ...
    Com base nas análises realizadas, foram identificadas
    oportunidades relevantes de recuperação de receita
    associadas principalmente ao envelhecimento do parque
    de hidrômetros, inconsistências entre consumo e faturamento
    e padrões atípicos de comportamento comercial.

    Os dados indicam que hidrômetros com idade superior
    à vida útil recomendada apresentam maior potencial
    de submedição e perdas financeiras, reforçando
    a necessidade de substituição preventiva.

    Recomenda-se:
    • Substituição gradual dos hidrômetros críticos;
